...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-md fixed top-0 py-2.5 w-full z-10">
      {/* <!-- navbar container --> */}
      <div className="w-full px-1 sm:px-4 m-auto flex justify-between items-center relative">
        {/* <!-- logo & search container --> */}
        <div className="flex items-center flex-1">
          <Link className="h-10 mr-1 sm:mr-24" to="/">
            <img
              draggable="false"
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          {isAuthenticated === false ? (
            ...
            <span
              className="userDropDown flex items-center font-medium gap-1 cursor-pointer"
          ...
          <Link
            to="/cart"
            className="flex items-center font-medium gap-2 relative"
          >
            <span>
              <ShoppingCartIcon />
            </span>
